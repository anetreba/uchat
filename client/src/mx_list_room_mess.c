        ...
        if (((t_list_room *)(lst->data))->room_id == room_id) {
            ...
            while (mess) {
                ...
                if (((t_mess *)(mess->data))->sender_id == event->data->id) {
                    gtk_widget_set_halign(((t_mess * )(mess->data))->message_button,
                                          GTK_ALIGN_END); // <---- END - твои сообщения, START пришедшие
                    ...
                    gtk_widget_set_name(((t_mess *)(mess->data))->message_button, "message_reciever");
                }
